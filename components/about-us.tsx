        ...
        <div>
          ...
          <div>
            <p className="pb-2 indent-4">
              <strong>sakhuravi.ge</strong> არის თქვენი საიმედო პარტნიორი
              სახურავის შეკეთებისა და მონტაჟის სფეროში. ჩვენი გუნდი აერთიანებს
              მაღალკვალიფიციურ ხელოსნებს, რომლებსაც მრავალწლიანი გამოცდილება
              აქვთ ნებისმიერი სირთულისა და ტიპის სახურავთან მუშაობაში.
            </p>
            <p className="pb-2 indent-4">
